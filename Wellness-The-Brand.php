<?php 
/**
* template name: Wellness The Brand
*/
get_header();?>
...
?>
<div class="healthandwellness_baner"  style="background: url('<?php echo $featured_image; ?>') no-repeat !important;background-size:cover !important;">
<div class="img_healthandwellness">
...
<div class="text_body_healthandwellness">
<div class="wraper">
<?php if (have_posts()) : while (have_posts()) : the_post();?>  
<?php the_content(); ?>
<?php endwhile; endif; ?>
</div><!-- ends wraper-->
</div><!-- ends textarea_health_section-->
